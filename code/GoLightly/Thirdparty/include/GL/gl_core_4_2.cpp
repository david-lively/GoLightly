...
static void* AppleGLGetProcAddress (const GLubyte *name)
{
  ...
  if (NULL == image)
  {
    image = NSAddImage("/System/Library/Frameworks/OpenGL.framework/Versions/Current/App", NSADDIMAGE_OPTION_RETURN_ON_ERROR);
  }
...
namespace gl
{
	...
	namespace _detail
	{
		...
		typedef void (CODEGEN_FUNCPTR *PFNRELEASESHADERParser)();
		PFNRELEASESHADERParser ReleaseShaderParser = 0;
		...
		static int LoadCoreFunctions()
		{
			...
			ReleaseShaderParser = reinterpret_cast<PFNRELEASESHADERParser>(IntGetProcAddress("glReleaseShaderParser"));
			if(!ReleaseShaderParser) ++numFailed;
