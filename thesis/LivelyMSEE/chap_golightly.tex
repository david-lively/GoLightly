...
\iffalse
Ifthe simulator was enhanced to support three-dimensional domains, models could be constructed in a similar manner.
\fi
...
Note the second peak in the source value. This is due to the reflected wave reaching the source monitor. 
