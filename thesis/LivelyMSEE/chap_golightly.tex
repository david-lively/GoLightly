...
The simulation was then run with $\epsilon_R = 9$ in the dielectric slab area to record combined incidence and reflcectiono, as well as transmittance within the dielectric.
