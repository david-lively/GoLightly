...
Users typically run many different applications in parallel: a web browser, music player, word processor and email client are a common combination. Multicore CPUs are designed to facilitate this by providing separate ALUs, register sets and cache, minimizing dependencies between cores on the same physical device. 
